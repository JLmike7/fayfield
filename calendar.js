  ...
  var CATALOG = {
    sources: [
      ...
      },
      {
        ...
        timezone: "America/New_York",
        enabled: true,
        notes: "Public ICS (Civil & Family Court catID=30) via same-origin snapshot.",
      },
      {
        id: "city-of-york",
        name: "City of York",
        ...
        sourceHomepage: "https://www.yorkcity.org/calendar/",
        ...
        timezone: "America/New_York",
        enabled: false,
        notes: "Opt-in. Official City of York iCal feed via same-origin snapshot.",
      },
      {
        id: "hellam-township",
        ...
        group: "Nearby",
        defaultEnabled: false,
        sourceHomepage: "https://www.hellamtownship.com/calendar/",
      ...
      },
      {
        ...
        timezone: "America/New_York",
        enabled: false,
        notes: "Opt-in. YSSD East York Elementary Google public ICS via snapshot.",
      },
      {
        ...
        timezone: "America/New_York",
        enabled: false,
        notes: "Opt-in. YSSD District-Wide Google public ICS via snapshot.",
      },
      {
        ...
        group: "YSSD",
        defaultEnabled: false,
        sourceHomepage: "https://www.yssd.org/school-board/sb-meeting-schedule",
        icsUrl:
        ...
        timezone: "America/New_York",
        enabled: false,
        notes: "Opt-in. YSSD School Board Google public ICS via snapshot.",
      },
      {
        id: "yssd-athletics",
        ...
        group: "YSSD",
        defaultEnabled: false,
        sourceHomepage: "https://www.yssd.org/departments/ysathletics/athletics-calendar",
        icsUrl:
        ...
        timezone: "America/New_York",
        enabled: false,
        notes: "Opt-in. YSSD Trojan Athletics Google public ICS via snapshot.",
      },
      {
        id: "yssd-cycle-days",
        ...
        timezone: "America/New_York",
        enabled: false,
        notes: "Opt-in. YSSD Cycle Days Google public ICS via snapshot.",
      },
      {
